...
const transporter = nodemailer_1.default.createTransport({
    secure: true,
    auth: {
        user: config_1.default.EMAIL_SENDER.SMTP_USER,
        pass: config_1.default.EMAIL_SENDER.SMTP_PASS,
    },
    port: Number(config_1.default.EMAIL_SENDER.SMTP_PORT),
    host: config_1.default.EMAIL_SENDER.SMTP_HOST,
});
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, subject, attachments, templateName, templateData }) {
    try {
        ...
        const info = yield transporter.sendMail({
            from: config_1.default.EMAIL_SENDER.SMTP_FROM,
            to: to,
            subject: subject,
            html: html,
        ...
        throw new ApiError_1.default(401, "Email error");
    }
});
